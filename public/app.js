...
var _user$project$App$theServerUrl = function (flags) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		A2(_elm_lang$core$Maybe$withDefault, '', flags.serverUrl),
		'/operating_hours');
};
...
var _user$project$App$Model = F3(
	function (a, b, c) {
		return {startTime: a, endTime: b, serverUrl: c};
	});
var _user$project$App$JsonResponse = F2(
	function (a, b) {
		return {start_time: a, end_time: b};
	});
var _user$project$App$decodeJsonOperationHoursResponse = A3(
	_elm_lang$core$Json_Decode$map2,
	_user$project$App$JsonResponse,
	A2(
	...
	A2(
		...
		'end_time',
		_elm_lang$core$Json_Decode$maybe(_elm_lang$core$Json_Decode$string)));
var _user$project$App$ReceiveUpdatedOperatingHoursDetails = function (a) {
	return {ctor: 'ReceiveUpdatedOperatingHoursDetails', _0: a};
};
var _user$project$App$updateOperatingHoursDetails = function (model) {
	return A2(
		_lukewestby$elm_http_builder$HttpBuilder$send,
		_user$project$App$ReceiveUpdatedOperatingHoursDetails,
		A2(
			_lukewestby$elm_http_builder$HttpBuilder$withExpect,
			_elm_lang$http$Http$expectJson(_user$project$App$decodeJsonOperationHoursResponse),
			A2(
				_lukewestby$elm_http_builder$HttpBuilder$withUrlEncodedBody,
				{
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'start_time', _1: model.startTime},
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'end_time', _1: model.endTime},
						_1: {ctor: '[]'}
					}
				},
				_lukewestby$elm_http_builder$HttpBuilder$put(model.serverUrl))));
};
var _user$project$App$ReceiveOperatingHoursDetails = function (a) {
	return {ctor: 'ReceiveOperatingHoursDetails', _0: a};
};
var _user$project$App$getOperatingHoursDetails = function (model) {
	return A2(
		_elm_lang$http$Http$send,
		_user$project$App$ReceiveOperatingHoursDetails,
		A2(_elm_lang$http$Http$get, model.serverUrl, _user$project$App$decodeJsonOperationHoursResponse));
};
var _user$project$App$init = function (flags) {
	return {
		...
		_0: A3(
			...
			'',
			'',
			_user$project$App$theServerUrl(flags)),
		_1: _user$project$App$getOperatingHoursDetails(
			A3(
				_user$project$App$Model,
				'',
				'',
...
var _user$project$App$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'RefreshOperatingHours':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$App$getOperatingHoursDetails(model)
				};
			case 'UpdateOperatingHours':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$App$updateOperatingHoursDetails(model)
				};
			...
			case 'UpdateEndTime':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						...
						{endTime: _p0._0}),
					{ctor: '[]'});
			case 'ReceiveOperatingHoursDetails':
				if (_p0._0.ctor === 'Ok') {
					var _p1 = _p0._0._0;
					return A2(
						...
						_elm_lang$core$Basics$toString(_p1),
						{
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{
									startTime: A2(_elm_lang$core$Maybe$withDefault, '', _p1.start_time),
									endTime: A2(_elm_lang$core$Maybe$withDefault, '', _p1.end_time)
								}),
					...
					return A2(
						...
						_elm_lang$core$Basics$toString(_p2),
						{
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{
									startTime: A2(_elm_lang$core$Maybe$withDefault, '', _p2.start_time),
									endTime: A2(_elm_lang$core$Maybe$withDefault, '', _p2.end_time)
								}),
							_1: _elm_lang$core$Platform_Cmd$none
						});
				} else {
...
var _user$project$App$UpdateEndTime = function (a) {
	return {ctor: 'UpdateEndTime', _0: a};
};
var _user$project$App$UpdateStartTime = function (a) {
	return {ctor: 'UpdateStartTime', _0: a};
};
var _user$project$App$UpdateOperatingHours = {ctor: 'UpdateOperatingHours'};
var _user$project$App$RefreshOperatingHours = {ctor: 'RefreshOperatingHours'};
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Operating Hours'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(_user$project$App$RefreshOperatingHours),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
				...
				_1: {
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$id('end_time'),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$type_('text'),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$value(model.endTime),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onInput(_user$project$App$UpdateEndTime),
											_1: {ctor: '[]'}
										}
									}
								}
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$id('start_time'),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$type_('text'),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$value(model.startTime),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onInput(_user$project$App$UpdateStartTime),
												_1: {ctor: '[]'}
											}
										}
									}
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onClick(_user$project$App$UpdateOperatingHours),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
								...
								_1: {
									...
									_1: {
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text(model.startTime),
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text(model.endTime),
													_1: {ctor: '[]'}
												}),
											_1: {ctor: '[]'}
										}
